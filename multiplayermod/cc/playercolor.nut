                ...
                try {
                    if (argsog[0] == " door") {
                        if (GetMapName() == "mp_coop_lobby_3") {
                            p.SetModel("models/props/portal_door_combined.mdl")
                        } else {
                            return SendChatMessage("Invalid map! Map must be mp_coop_lobby_3 to do this!",p)
                        }
                    } else {
                        // SendChatMessage("idiot",p)
                        // SendCha
                        args <- [argsog[0], 0, 0]
                    }
                } catch (exception) {
