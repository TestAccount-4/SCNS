...
//models/props/metal_box.mdl 												works for any map
...
local MODEL1 = "models/props/metal_box.mdl" //Model you want to set here (MUST be within the level or precached via creation commands.)
